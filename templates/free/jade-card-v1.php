...
/* Alignment Settings */
$jade_align_content = get_field('jade_align_content');
...
<div class="jd-card jd-card__v1 <?php echo $jade_id . $jade_align; ?>" <?php echo ($jade_card_background_color ) ? 'style="background-color: '. $jade_card_background_color . '; border-radius: '. $jade_border_radius. 'px; "' : '' ?>>
    ...
    <div class="jd-card__content <?php echo $jade_align_content; ?>">
